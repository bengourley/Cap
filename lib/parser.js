...
var createParser = function () {
  ...
  var multilineExpression = function (opts) {
    return expression(opts) || literal();
  };
  ...
  var call = function (expr) {
    ...
    call = (function reduce(exprs) {
      ...
      return node({
        type : 'call',
        childNodes : [
          exprs.length === 1 ? exprs[0] : reduce(exprs),
          arg
        ]
      });
    }(exprs));
  ...
  var literalDef = function () {
    ...
    default:
      throw new Error('Could not match a literal');
    }
  };
  ...
  var conditional = function () {
    ...
    return node({
      type : 'conditional',
      childNodes : [iff].concat(elseIfs).concat([elsee])
    });
  };
