...
var $0 = $$.length - 1;
switch (yystate) {
case 1: return new yy.nodes.Program($$[$0]); 
break;
...
case 4: this.$ = []; 
break;
case 9: this.$ = new yy.nodes.Call($$[$0-1], $$[$0]); 
break;
case 13: this.$ = $$[$0-1] 
break;
case 14: this.$ = [$$[$0-2], $$[$0]] 
...
break;
case 16: this.$ = new yy.nodes.Assign($$[$0-2], $$[$0]); 
break;
case 17: this.$ = new yy.nodes.Conditional($$[$0-1][0], $$[$0-1][1], ''); 
break;
case 18: this.$ = new yy.nodes.Conditional($$[$0-3][0], $$[$0-3][1], $$[$0-1]); 
break;
case 19: this.$ = new yy.nodes.Conditional($$[$0-5][0], $$[$0-5][1], $$[$0-1]); 
break;
case 20: this.$ = [$$[$0-5], $$[$0-1]] 
break;
case 22: this.$ = $$[$0-1]; 
break;
case 23: this.$ = new yy.nodes.Where($$[$0-7], $$[$0-2]); 
break;
case 24: this.$ = [$$[$0]] 
break;
...
case 32: this.$ = $$[$0-1] 
break;
case 35: this.$ = new yy.nodes.Object($$[$0-2]); 
break;
case 36: this.$ = new yy.nodes.Function($$[$0-1], $$[$0-5]); 
break;
case 37: this.$ = $$[$0-3].concat([[$$[$0-1], $$[$0]]]); 
break;
case 38: this.$ = [[$$[$0-1], $$[$0]]]; 
break;
case 41: this.$ = new yy.nodes.Primative($$[$0]) 
break;
case 43: this.$ = $$[$0-2] + '.' + $$[$0] 
break;
case 45: this.$ = new yy.nodes.DynamicId($$[$0-3], $$[$0]); 
break;
case 46: this.$ = new yy.nodes.Primative(yytext); 
break;
case 47: this.$ = yytext; 
break;
case 48: this.$ = new yy.nodes.Primative(yytext); 
break;
}
},
